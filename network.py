...
class Network(nn.Module):
    ...
    def __init__(self):
        super().__init__()
        self.cv1 = nn.Conv3d(1, 16, 2, stride=(1,1,1), padding=0) #try increasing filter size
        self.bn1 = nn.BatchNorm3d(16)
        self.cv2 = nn.Conv3d(16, 32, 2, stride=(1,1,1), padding=0) #try increase filter size
        self.bn2 = nn.BatchNorm3d(32)
        self.cv3 = nn.Conv3d(32, 64, 2,stride=(1,1,1), padding=0)
        self.bn3 = nn.BatchNorm3d(64)
        self.cv4 = nn.Conv3d(64, 128, 2,stride=(1,1,1), padding=0)
        self.bn4 = nn.BatchNorm3d(128)
        self.cv5 = nn.Conv3d(128, 128, 2,stride=(1,1,1), padding=0)
